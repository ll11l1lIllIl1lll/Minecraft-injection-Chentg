...
public class AltAxisAlignedBB
{
    ...
    public static AltAxisAlignedBB getBoundingBox(final double par0, final double par2, final double par4, final double par6, final double par8, final double par10) {
    ...
    public AltAxisAlignedBB(final double par1, final double par3, final double par5, final double par7, final double par9, final double par11) {
        this.minX = par1;
        this.minY = par3;
        this.minZ = par5;
        this.maxX = par7;
    ...
    public AltAxisAlignedBB setBounds(final double par1, final double par3, final double par5, final double par7, final double par9, final double par11) {
        this.minX = par1;
        this.minY = par3;
        this.minZ = par5;
        this.maxX = par7;
    ...
    public AxisAlignedBB addCoord(final double par1, final double par3, final double par5) {
        ...
        getAABBPool();
        return AxisAlignedBB.getBoundingBox(var7, var8, var9, var10, var11, var12);
    }
    ...
    public AxisAlignedBB union(final AltAxisAlignedBB par1AxisAlignedBB) {
        final double var2 = Math.min(this.minX, par1AxisAlignedBB.minX);
        final double var3 = Math.min(this.minY, par1AxisAlignedBB.minY);
        final double var4 = Math.min(this.minZ, par1AxisAlignedBB.minZ);
        final double var5 = Math.max(this.maxX, par1AxisAlignedBB.maxX);
        final double var6 = Math.max(this.maxY, par1AxisAlignedBB.maxY);
        final double var7 = Math.max(this.maxZ, par1AxisAlignedBB.maxZ);
        getAABBPool();
        return AxisAlignedBB.getBoundingBox(var2, var3, var4, var5, var6, var7);
    }
    ...
    public double calculateXOffset(final AltAxisAlignedBB par1AxisAlignedBB, double par2) {
    ...
    public double calculateYOffset(final AltAxisAlignedBB par1AxisAlignedBB, double par2) {
    ...
    public double calculateZOffset(final AltAxisAlignedBB par1AxisAlignedBB, double par2) {
        if (par1AxisAlignedBB.maxX <= this.minX || par1AxisAlignedBB.minX >= this.maxX) {
            return par2;
        }
        if (par1AxisAlignedBB.maxY > this.minY && par1AxisAlignedBB.minY < this.maxY) {
    ...
    public boolean intersectsWith(final AltAxisAlignedBB par1AxisAlignedBB) {
    ...
    public AltAxisAlignedBB offset(final double par1, final double par3, final double par5) {
        this.minX += par1;
        this.minY += par3;
        this.minZ += par5;
        this.maxX += par1;
    ...
    public MovingObjectPosition calculateIntercept(final Vec3 par1Vec3, final Vec3 par2Vec3) {
        ...
        return new MovingObjectPosition(0, 0, 0, (int)var10, var9);
    }
    ...
    public void setBB(final AltAxisAlignedBB par1AxisAlignedBB) {
